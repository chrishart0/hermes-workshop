# Agenda Notes - 2.5-Hour Format

> Source material from the 2.5-hour version of this workshop. The July 18 session
> runs 4 hours and follows the [Four-Hour Workshop Outline](full-workshop-outline.md);
> use the timings below as per-block guidance, not the schedule for the day.
